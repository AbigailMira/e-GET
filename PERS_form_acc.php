			...
			include("../Includes/eg_asidenav.php")
			 ?>
				...
				<div id="grille" class="col-lg-9 col-md-9 col-sm-8 col-xs-8">
					<section>
						<h3>Accueil-Personnels</h3>
                        <hr>
                        <div>
                            <form class = "form-inline row" action="/action_page.php"><!-- traitement de la recherche -->
								<div class="form-group lsearch">
									<div>
										<label for="search"><h4>Chercher une personne : </h4></label>
									</div>
								</div>
								<div class="form-group search">	
									<div>
										<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Chercher une personne ..." title="Type in a person">
